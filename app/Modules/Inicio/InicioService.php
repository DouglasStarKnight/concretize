...
class InicioService
{
    ...
    public function __construct(private InicioModel $registerModel, private AdminModel $adminModel, private SlidesModel $slidesModel, private DestaqueModel $destaqueModel){
